...
exec_until_ready "aws --endpoint-url=http://ses:4579 ses verify-email-identity --email-address backend-integration@social.network"
...
exec_until_ready "aws --endpoint-url=http://sns:4575 sns create-platform-application --name integration-network.social.ent --platform APNS_SANDBOX --attributes PlatformCredential=testprivatekey"
