...
legalHoldFeatureFlagNotEnabled = Error status403 "legalhold-not-enabled" "legal hold is not enabled for this society instance"
...
disableSsoNotImplemented =
  Error
    ...
    \open an issue on https://github.com/social-network/society-server."
