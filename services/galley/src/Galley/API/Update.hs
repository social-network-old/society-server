...
import Galley.Types.Conversations.Roles (Action (..), RoleName, roleNameSocietyMember)
...
joinConversation zusr zcon cnv access = do
  ...
  addToConversation (botsAndUsers (Data.convMembers conv)) (zusr, roleNameSocietyMember) zcon ((,roleNameSocietyMember) <$> newUsers) conv
