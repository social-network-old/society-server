...
getByDomainFound = do
  ...
  let jsonBody :: Value
      jsonBody =
        [aesonQQ|{
          "config_json_url": "https://society-rest.https.no2.com/config.json",
          "webapp_welcome_url": "https://app.society.no2.com/"
          }|]
...
getByDomainDeleted = do
  ...
  let jsonBody :: Value
      jsonBody =
        [aesonQQ|{
          "config_json_url": "https://society-rest.https.no3.com/config.json",
          "webapp_welcome_url": "https://app.society.no3.com/"
          }|]
