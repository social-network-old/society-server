...
type IdP = IdPConfig SocietyIdP

data SocietyIdP = SocietyIdP
  { _wiTeam :: TeamId,
...
makeLenses ''SocietyIdP

deriveJSON deriveJSONOptions ''SocietyIdP
...
data Opts' a = Opts
  { saml :: !SAML.Config,
    ...
    richInfoLimit :: !Int,
    -- | Society/AWS specific; optional; used to discover Cassandra instance
