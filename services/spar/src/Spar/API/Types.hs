...
--
-- Why a special cookie, and not the cookie already available, or the session token?  The society cookie
...
--
--   * team admin posts the initiate-bind link in a group in the society team.  no new UI components
