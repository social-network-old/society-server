...
* Run backfill using
  ...
  docker run quay.io/society/backfill-billing-team-members:2.81.18 \
...
- Add a new type of authorization tokens for legalhold (for details on legalhold, see https://github.com/social-network/society-server/blob/develop/docs/reference/team/legalhold.md) (#761)
...
* SCIM users now have an additional society-specific schema attached.
...
- Add Prometheus middleware for society-services (#672)
...
## Internal changes
  ...
  * Whitelist all social.network email addresses (#578)
  * SCIM -> Scim (#581)
...
## New Features
  ...
  * SSO: shell script for registering IdPs in society-teams.
