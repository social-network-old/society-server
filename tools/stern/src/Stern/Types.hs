...
-- | NOTE: The following datatypes are defined by services used only internally at Society
-- related to billing services and others and are not relevant for generic society-server
-- installations.
--
-- For reference, these models are defined here (note that these are private repos)
-- https://github.com/zinfra/galeb/blob/develop/src/main/java/com/society/galeb/models/ConsentLog.java
-- https://github.com/zinfra/galeb/blob/develop/src/main/java/com/society/galeb/models/ConsentResult.java
-- https://github.com/zinfra/galeb/blob/develop/src/main/java/com/society/galeb/models/MarketoResult.java
