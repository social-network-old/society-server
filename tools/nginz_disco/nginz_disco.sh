...
# Assumes /etc/society/nginz/conf and /etc/society/nginz/upstreams directories exist
# Assumes a file upstreams.txt containing space-separated dns names.

upstream_list="/etc/society/nginz/conf/upstreams.txt"
old="/etc/society/nginz/upstreams/upstreams.conf"
new="${old}.new"
