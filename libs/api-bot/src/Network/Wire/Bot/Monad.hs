...
module Network.Society.Bot.Monad
  ( -- * Environment
    BotNetEnv,
    newBotNetEnv,
    getBotSettings,
...
import Network.Society.Bot.Cache (Cache, CachedUser (..))
import qualified Network.Society.Bot.Cache as Cache
import Network.Society.Bot.Clients as Clients
import Network.Society.Bot.Crypto.Glue
import Network.Society.Bot.Email
import qualified Network.Society.Bot.Metrics as Metrics
import Network.Society.Bot.Report
import Network.Society.Bot.Report.Text
import Network.Society.Bot.Settings
import Network.Society.Client
import Network.Society.Client.API.Auth
import Network.Society.Client.API.Client
import Network.Society.Client.API.Push
import Network.Society.Client.API.User
...
randUser (Email loc dom) (BotTag tag) = do
  ...
  return
    ( NewUser
        { newUserDisplayName = Name (tag <> "-Societybot-" <> pack (toString uuid)),
          newUserUUID = Nothing,
