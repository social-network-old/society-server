...
-- | This module exports types and functions from Database.CQL.IO, while adding a few society specific functions.
...
-- | This function is likely only useful at Society, as it is Society-infra specific.
-- Given a server name and a url returning a society-custom "disco" json (AWS describe-instances-like json), e.g.
