...
import Imports
import Society.API.Event.Team
import Society.API.Team (NewTeam (..), Team (..), TeamBinding (..))
import Society.API.Team
import Society.API.Team.Conversation
...
-- See also 'Society.API.Team.SearchVisibility.TeamSearchVisibilityEnabled',
-- 'Society.API.Team.SearchVisibility.TeamSearchVisibility'.
