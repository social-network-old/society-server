...
module Society.API.User.RichInfo
  ( -- * RichInfo
    RichInfo (..),
    toRichInfoAssocList,
    richInfoMapSize,
...
richInfoMapURN = "urn:ietf:params:scim:schemas:extension:society:1.0:User"
richInfoAssocListURN = "urn:society:scim:schemas:profile:1.0"
