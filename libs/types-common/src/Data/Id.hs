...
instance EncodeSociety (Id a) where
  encodeSociety t = encodeSociety t . toUUID

instance DecodeSociety (Id a) where
  decodeSociety = fmap Id . decodeSociety

instance EncodeSociety UUID where
  encodeSociety t = encodeSociety t . L.toStrict . UUID.toByteString

instance DecodeSociety UUID where
  decodeSociety (DelimitedField _ bs) =
    maybe (fail "Invalid UUID") pure . UUID.fromByteString . L.fromStrict $ bs
  decodeSociety _ = fail "Invalid UUID"
...
instance EncodeSociety ClientId where
  encodeSociety t = encodeSociety t . client

instance DecodeSociety ClientId where
  decodeSociety (DelimitedField _ x) = either fail return (runParser parser x)
  decodeSociety _ = fail "Invalid ClientId"
...
instance EncodeSociety RequestId where
  encodeSociety t = encodeSociety t . unRequestId

instance DecodeSociety RequestId where
  decodeSociety = fmap RequestId . decodeSociety
