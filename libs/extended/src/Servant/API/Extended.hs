...
-- https://github.com/social-network/servant-uverb/blob/3647c488a88137d3ec2583b518bda59ee7072278/servant-uverb/src/Servant/API/UVerb.hs#L33-L57
--
...
-- streaming and performance!), or re-society more of the servant internals (unclear how hard
-- that'll be).
--
